class ZCL_ZGW_BORRFC_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZGW_BORRFC_MPC============CP' ##NO_TEXT.
...
CLASS ZCL_ZGW_BORRFC_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZGW_BORRFC_SRV' ).
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'BusinessPartner_SalesOrders' "#EC NOTEXT
                            iv_left_type        = 'BusinessPartner' "#EC NOTEXT
                            iv_right_type       = 'SalesOrder' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - BusinessPartner_SalesOrders
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'BusinessPartnerID'   iv_dependent_property = 'BuyerId' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'BusinessPartner_SalesOrdersSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'BusinessPartnerSet'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'SalesOrderSet'             "#EC NOTEXT
                                              iv_association_name      = 'BusinessPartner_SalesOrders' ).                                 "#EC NOTEXT

 lo_association = model->create_association(
                            iv_association_name = 'Country_BusinessPartners' "#EC NOTEXT
                            iv_left_type        = 'Country' "#EC NOTEXT
                            iv_right_type       = 'BusinessPartner' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - Country_BusinessPartners
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'Key'   iv_dependent_property = 'Country' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'Country_BusinessPartnersSet'                         "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGW_BORRFC_MPC=>TS_BUSINESSPARTNER' ). "#EC NOTEXT
...
lo_property = lo_entity_type->create_property( iv_property_name = 'Key' iv_abap_fieldname = 'LAND1' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGW_BORRFC_MPC=>TS_COUNTRY' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZGW_BORRFC_MPC=>TS_SALESORDER' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20260326044734'.                  "#EC NOTEXT
