class ZCL_ZGW_BORRFC_DPC definition
  public
...
protected section.
  ...
  methods BUSINESSPARTNERS_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZGW_BORRFC_MPC=>TS_BUSINESSPARTNER
    raising
  ...
  methods BUSINESSPARTNERS_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZGW_BORRFC_MPC=>TT_BUSINESSPARTNER
  ...
  methods COUNTRYSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZGW_BORRFC_MPC=>TS_COUNTRY
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods COUNTRYSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZGW_BORRFC_MPC=>TT_COUNTRY
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods SALESORDERSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZGW_BORRFC_MPC=>TS_SALESORDER
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods SALESORDERSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZGW_BORRFC_MPC=>TT_SALESORDER
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS ZCL_ZGW_BORRFC_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 26.03.2026 04:47:38 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZGW_BORRFC_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA salesorderset_create_entity TYPE zcl_zgw_borrfc_mpc=>ts_salesorder.
 DATA businesspartners_create_entity TYPE zcl_zgw_borrfc_mpc=>ts_businesspartner.
 DATA countryset_create_entity TYPE zcl_zgw_borrfc_mpc=>ts_country.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA salesorderset_get_entity TYPE zcl_zgw_borrfc_mpc=>ts_salesorder.
 DATA businesspartners_get_entity TYPE zcl_zgw_borrfc_mpc=>ts_businesspartner.
 DATA countryset_get_entity TYPE zcl_zgw_borrfc_mpc=>ts_country.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZGW_BORRFC_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA salesorderset_get_entityset TYPE zcl_zgw_borrfc_mpc=>tt_salesorder.
 DATA businesspartners_get_entityset TYPE zcl_zgw_borrfc_mpc=>tt_businesspartner.
 DATA countryset_get_entityset TYPE zcl_zgw_borrfc_mpc=>tt_country.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA salesorderset_update_entity TYPE zcl_zgw_borrfc_mpc=>ts_salesorder.
 DATA businesspartners_update_entity TYPE zcl_zgw_borrfc_mpc=>ts_businesspartner.
 DATA countryset_update_entity TYPE zcl_zgw_borrfc_mpc=>ts_country.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
IF  lv_source_entity_set_name = 'BusinessPartnerSet'.
  " Convert keys to appropriate entity set structure
  io_tech_request_context->get_converted_source_keys(
    IMPORTING
      es_key_values  = businesspartners_get_entity ).
  ...
  CALL METHOD me->businesspartners_get_entity
    EXPORTING
      ...
      it_navigation_path      = it_navigation_path
    IMPORTING
      er_entity               = businesspartners_get_entity.
  ls_selopt-sign = 'I'.
  ls_selopt-option = 'EQ'.
  ls_selopt-low = businesspartners_get_entity-country.
...
LOOP AT lt_filter_select_options INTO ls_filter.
  ...
  CASE ls_filter-property.
    WHEN 'LAND1'.              " Equivalent to 'Key' property in the service
...
*  Data declaration
*-------------------------------------------------------------
 DATA max_rows TYPE zif_bapi_epm_so_get_list=>bapi_epm_max_rows.
 ...
 DATA ls_converted_keys LIKE LINE OF et_entityset.
 DATA lv_source_entity_set_name TYPE string.
 DATA businesspartners_get_entityset TYPE LINE OF zcl_zgw_borrfc_mpc=>tt_businesspartner.
 DATA ls_filter TYPE /iwbep/s_mgw_select_option.
 DATA ls_filter_range TYPE /iwbep/s_cod_select_option.
...
* Maps key fields to function module parameters
 IF it_key_tab IS NOT INITIAL.
   ...
   IF  lv_source_entity_set_name = 'BusinessPartnerSet'.
     ...
     io_tech_request_context->get_converted_source_keys(
       IMPORTING
         es_key_values  = businesspartners_get_entityset ).
   ENDIF.
